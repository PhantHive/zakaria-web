<template>
  <div v-if="!consentGiven" class="consent-banner">
    ...
    <div class="consent-text">
      <p>This magical site uses cookies to enhance your experience! ✨</p>
      <button @click="giveConsent" class="consent-button">Okay, got it!</button>
    </div>
  </div>
</template>
